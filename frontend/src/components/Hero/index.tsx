            ...
            <div className="w-full px-4">
              <div className="mx-auto max-w-[800px] text-center">
                <h1 className="mb-5 text-3xl leading-tight font-bold text-black sm:text-4xl sm:leading-tight md:text-5xl md:leading-tight dark:text-white">
                  Facility Location and Room Allocation for Schools and
                  Enterprises
                </h1>
                <p className="text-body-color dark:text-body-color-dark mb-12 text-base leading-relaxed! sm:text-lg md:text-xl">
                  Our project focuses on optimizing the location of facilities
                  and the allocation of rooms within schools or enterprises.
                  Using advanced optimization techniques such as Linear
                  Programming (LP) and Mixed-Integer Linear Programming (MILP),
                  our application helps make data-driven decisions to
                  efficiently manage spaces and resources, reducing costs and
